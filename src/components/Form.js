...
const Form = ({ setItemName, setPrice, setQuantity, setIsDuplicate, isDuplicate, submit, state: { price, name } }) => {
    ...
    return (
        <>
            <FormWrapper onSubmit={handleSubmit}>
                ...
                <InputWrapper>
                    <Label htmlFor="itemPrice">Price (R)</Label><Input color="grey" id="itemPrice" type="number" value={price} onChange={(e) => setPrice(e.target.value)} required />
                </InputWrapper>
                <InputWrapper>
                    <Label htmlFor="quantity">Quantity</Label>
                    <Input color="grey" as="select" name="quantity" id="quantity" onChange={(e) => setQuantity(e.target.value)}>
